...
def load_bigvgan(ckpt = '/share/mini1/res/t/vc/studio/timap-en/svcc2023/BigVGAN/exp/bigvgan/g_00626000', config = '/share/mini1/res/t/vc/studio/timap-en/svcc2023/BigVGAN/exp/bigvgan/config.json', device = 'cpu'):
