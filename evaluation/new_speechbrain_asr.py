...
class ASR(sb.core.Brain):
    ...
    def compute_objectives(self, predictions, batch, stage):
        ...
        if stage != sb.Stage.TRAIN:
            ...
            if current_epoch % valid_search_interval == 0 or (
                ...
                self.token_out_f.write(f'{batch.id[0]}|{predicted_words_str}|{batch.wrd[0]}\n')
                print(f'{batch.id[0]}|{predicted_words_str}|{batch.wrd[0]}')
    ...
    def on_stage_start(self, stage, epoch):
        ...
        if stage != sb.Stage.TRAIN:
            ...
            self.token_out_f = open(os.path.join(self.hparams.output_folder, 'token.txt'), 'w')
