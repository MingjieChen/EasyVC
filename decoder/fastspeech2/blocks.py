...
class WadaINFeedForward(nn.Module):
    """ A two-feed-forward-layer """

    def __init__(self, d_in, d_hid, kernel_size, dropout=0.1, spk_emb_dim = 256):
        super(WadaINFeedForward, self).__init__()
    ...
    def forward(self, x, spk_emb):
        ...
        output = self.w_2(F.relu(self.w_1(output)), spk_emb)
